...
#    保留 types/ledger.ts 原名(與既有 types/api.ts 命名慣例一致)
# ============================================================
...
# 二次確認:全專案不應再有殘留的舊 @/api/ledger import 路徑
...
# ============================================================
# 2. 後端:GET /transactions 加入 tag_ids 篩選(OR 語意:符合任一品項即列入)
# ============================================================
python3 << 'PYEOF'
...
#    確保 tag_ids 以 FastAPI Query(list[str]) 預期的重複 key 格式送出
#    (axios 預設會序列化成 tag_ids[]=x,與後端格式不符)
# ============================================================
python3 << 'PYEOF'
...
# ============================================================
# 5. 新增 TagFilterPicker.vue(消費品項複選篩選,按鈕式,同 CategoryFilterPicker 風格)
# ============================================================
...
EOF
echo "✅ 已建立 components/TagFilterPicker.vue"

# ============================================================
# 6. 新增 AccountFilterPicker.vue(帳戶單選篩選,取代原生 <select>,同 CategoryFilterPicker 風格)
# ============================================================
...
EOF
echo "✅ 已建立 components/AccountFilterPicker.vue"
